...
function Navbar() {
    ...
    const fetchSublinks = async () => {
        try {
            ...
            const result1 = await apiConnector('GET', 'http://localhost:3000/api/v1/course/showAllCategories');
            console.log("Printing Sublinks result:", result1);
            setSubLinks(result1);
        } catch (error) {
    ...
    return (
        <div className={`z-[10] flex h-14 w-full items-center justify-center border-b-[1px] border-b-richblack-700 text-white translate-y-0 transition-all`}>
