...
export default function MobileProfileDropDown() {
    // Call hooks first to ensure consistent order
    ...
    // Fetch sublinks when the component mounts
    ...
    // useEffect hook to fetch the sublinks when component mounts
    useEffect(() => {
        fetchSublinks();
    }, [])

    // If no user data, return null early, but only after hooks
    if (!user) return null;
