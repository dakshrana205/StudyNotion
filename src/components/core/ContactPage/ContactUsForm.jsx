...
const ContactUsForm = () => {
  ...
  return (
    <form
      className="flex flex-col gap-7 p-4 bg-gray-900 rounded-lg shadow-lg"
      ...
      <div className="flex flex-col gap-5 lg:flex-row">
        <div className="flex flex-col gap-2 lg:w-[48%]">
          ...
          <input
            ...
            className="p-3 bg-gray-800 text-black border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
