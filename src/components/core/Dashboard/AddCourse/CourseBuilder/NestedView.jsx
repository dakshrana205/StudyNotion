...
import {
  deleteSection,
  deleteSubSection,
  updateSection, // Assuming you have an API to update the section name
...
export default function NestedView({ handleChangeEditSectionName }) {
  ...
  const handleSaveSectionName = async (sectionId) => {
    ...
    if (result) {
      const updatedCourseContent = course.courseContent.map((section) =>
        section._id === sectionId ? { ...section, sectionName: newSectionName } : section
      )
      const updatedCourse = { ...course, courseContent: updatedCourseContent }
      dispatch(setCourse(updatedCourse))
          ...
          <details key={section._id} open>
            ...
            <summary className="flex cursor-pointer items-center justify-between border-b-2 border-b-richblack-600 py-2">
              <div className="flex items-center gap-x-3">
                ...
                {editingSectionId === section._id ? (
                  <input
                    ...
                    className="text-richblack-50 font-semibold bg-transparent border-b-2 border-b-richblack-600"
                  />
                ) : (
              ...
              <div className="flex items-center gap-x-3">
                {editingSectionId === section._id ? (
                  <button
                    onClick={() => handleSaveSectionName(section._id)}
