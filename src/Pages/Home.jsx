...
const Home = () => {
    ...
    return (
        <React.Fragment>
            ...
            <div>
            <div className="w-full h-[450px] md:h-[650px] absolute top-0 left-0 overflow-hidden">
                <img src={backgroundImg} alt="Background" className="w-full h-full object-cover opacity-50" />
