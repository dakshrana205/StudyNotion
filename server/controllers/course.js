...
exports.getAllCourses = async (req, res) => {
    try {
        // Filter by status: Assuming the 'status' field indicates whether the course is published
        const allCourses = await Course.find({ status: 'published' }, // filter only published courses
            {
